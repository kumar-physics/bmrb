...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test__InterpretFile(self):
        ...
        self.assertEqual(bmrb._interpretFile("https://svn.bmrb.wisc.edu/svn/sans/python/unit_tests/sample_files/bmr15000_3.str").read(), local_version)
        self.assertEqual(bmrb._interpretFile("https://svn.bmrb.wisc.edu/svn/sans/python/unit_tests/sample_files/bmr15000_3.str.gz").read(), local_version)
    ...
    def test_schema(self):
        default = bmrb.schema()
        loaded =  bmrb.schema("https://svn.bmrb.wisc.edu/svn/nmr-star-dictionary/bmrb_star_v3_files/adit_input/xlschem_ann.csv")
